...
use comput::impacts::{cml::CML, ImpactCategory};
use errors::Result;
use crate::ecospold2::impacts::misc::{get_ecoinvent_mapping_file, get_empty_matrix};
...
pub fn get_cml_matrix(
    ...
    let mut rdr = get_ecoinvent_mapping_file(version, "CML v4.8 2016", cache_path)?;
